	...
	<div id="app">
		...
		<div class="conteudo">
			<form class="painel" v-if="!submetido">
				...
				<Rotulo nome="Senha">
					<input type="password" v-model.trim="senha">
				</Rotulo>
				<Rotulo nome="Armazenar Dados?">
					<select v-model="armazenarDados">
						<option value="true">Sim</option>
						<option value="false">Não</option>
					</select>
				</Rotulo>
				<Rotulo>
					<button type="submit" v-on:click="enviarFormulario()">Enviar formulário</button>
				</Rotulo>
				<!-- Exercicio 02 -->
			...
			<div class="painel" v-if="submetido">
